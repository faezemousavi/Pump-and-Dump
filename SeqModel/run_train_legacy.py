...
class FeatGenerator(object):
    ...
    def __init__(self, input_file, epoch=1, batch_size=256):
        ...
        print(f"Batch size: {self.feat_config['batch_size']}")
    ...
    def tensor_generation(self, features):
        with tf.name_scope('Embedding_layer'):
            ...
            with open("/content/drive/MyDrive/entezarivoive/TargetCoinPrediction/FeatGeneration/feature/wv_embedding.pkl", "rb") as f:
